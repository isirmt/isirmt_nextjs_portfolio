          ...
          <TechsProvider>
            ...
            <section aria-label="profile" className="relative w-full">
              <div className="relative z-10 mt-32 w-fit rounded-tr-4xl bg-[#ffe7bb] [box-shadow:.5rem_.5rem_0_0_#f7885c]">
                ...
                <div className="flex max-w-4xl items-center gap-10 pt-24 pr-44 pb-14 pl-36">
                  ...
                  <div className="flex flex-col gap-2.5 text-sm font-semibold tracking-wide text-[#61230b]">
